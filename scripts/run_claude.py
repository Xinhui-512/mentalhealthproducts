...
**事件概要**：
[写一段50-150字的内容，描述这个热搜话题的背景、最新动态或引发讨论的原因。让读者能快速了解发生了什么。]
...
**热度排名**：第5名 | **平台**：微博
**事件概要**：
近期多位博主发起"每日穿搭打卡"活动，要求学员每天在社交平台发布当日穿搭照片。此举引发关于隐私边界、社交压力以及审美焦虑的讨论，不少人表示这种公开监督让人感到被凝视，加剧了外貌焦虑和消费冲动。
**产品创意**：
- **创意名称**：私密衣橱
- **核心功能**：仅自己可见的穿搭记录，支持情绪标签记录每次穿搭的心情
- **目标用户**：有穿搭分享压力但希望保留私人空间的人群
- **有趣度评分**：75/100
- **有用度评分**：80/100
- **综合评分**：76分
